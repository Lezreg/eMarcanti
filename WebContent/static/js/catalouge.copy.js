...
$(document).ready(function() {
    ...
    $('#catalougecopytid tfoot th').each( function () {
        var title = $(this).text();
	...
	var table = $('#catalougecopytid').DataTable({
		dom: 'lBfrtip',
		/*buttons: [
...
// SINGLE POPUP ADD TO CART
 ...
 $('#catalougecopytid').on('click', '.popupone', function () {
        var name = $('td', this).eq(1).text();
        $('#DescModal').modal("show");
    });

$('#catalougecopytid').on('click', '.popuptwo', function () {
        var name = $('td', this).eq(1).text();
