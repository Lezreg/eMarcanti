...
@ManagedBean(name = "SOFilterView")
@ViewScoped
public class Soins {

	private static final Logger LOGGER = LoggerFactory.getLogger(Soins.class);
	...
	public List<ProduitBean> getProduits() {
		return produitServiceAction.getProductsByCategorie(userSessionBean.getIdOrga(), CategoriesEnum.CREME.getCode());
	}
