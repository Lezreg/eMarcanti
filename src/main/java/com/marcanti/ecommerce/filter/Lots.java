...
public class Lots {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(Lots.class);
	...
	public List<ProduitBean> getProduits() {
		return produitServiceAction.getProductsByCategorie(userSessionBean.getIdOrga(), CategoriesEnum.LOTS.getCode());
	}
