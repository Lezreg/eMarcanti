...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CommandeIndividuelle.findAll", query = "SELECT c FROM CommandeIndividuelle c")
...
public class CommandeIndividuelle implements Serializable {
    ...
    public CommandeIndividuelle(Long idCdeIndiv, String cdeIndivNom, Date dateCreation, boolean isPaiementEffectue, BigDecimal totalAPayer) {
        this.idCdeIndiv = idCdeIndiv;
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idCdeIndiv == null && other.idCdeIndiv != null) || (this.idCdeIndiv != null && !this.idCdeIndiv.equals(other.idCdeIndiv))) {
            return false;
        }
        return true;
    }
