...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CommandeGroupee.findAll", query = "SELECT c FROM CommandeGroupee c")
...
public class CommandeGroupee implements Serializable {
    ...
    public CommandeGroupee(Long idCdeGroupee, String cdeGroupeeNom, Date dateCreation, String nomCreateur, String prenomCreateur, boolean isPaiementEffectue, boolean isEnCours) {
        this.idCdeGroupee = idCdeGroupee;
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idCdeGroupee == null && other.idCdeGroupee != null) || (this.idCdeGroupee != null && !this.idCdeGroupee.equals(other.idCdeGroupee))) {
            return false;
        }
        return true;
    }
